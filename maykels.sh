...
echo
echo
toilet -f future "TEBAS Mr.Maykels" | lolcat
echo
...
echo $green "╭─"$blue"DEMON|TEAM"$cyan" ~/Mr.Maykels-ST"$white
read -p " ╰─$ "  target
echo
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"DEMON|TEAM"$cyan" ~/Mr.Maykels-ST"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $green"Author  : Mr.Maykels			"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[@] MR.NEWBIE & All Member RABBIT-ST "
echo $red"##########################$green" WELCOME "$red###########################"
